jQuery(function ($) {
    ...
    $.fn.SIInit = function() {
        ...
        // Modal photos
        $('a[data-fancybox]').each(function() {$(this).attr('rel', $(this).data('rel'));});
    ...
    $.fn.SIModalInit = function () {
        ...
        SIModals.attachModal('.open-orange-modal',  '.orange-modal', {'.send-extra': 'extra'});
        SIModals.attachModal('.open-mobile-nav',  '.mobile-nav', false);
        SIModals.attachModal('.open-text-modal', '.text-modal', '.pseudo-table', '.nav', false, function () {
            return '.text-modal-' + $(this).data('id');
            return '.pseudo-table-' + $(this).data('id');
        });
    ...
    // ===================================================== maps
    var myMap,
        centerCoord = [55.801349, 37.984417];
    ...
    function pointByPlacemark(mapBlock) {
        var myPlacemark = new ymaps.Placemark(
            centerCoord, {
                iconCaption: 'г. Балашиха, проспект Ленина, 74'
            }, {
